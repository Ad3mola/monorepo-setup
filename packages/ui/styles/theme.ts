 ...
 */
const fonts = {
  primary: `galanoLight, sans-serif`,
  galanoExtraBold: `galano-extra-bold, sans-serif`,
  galanoExtraLight: `galanoExtraLight, sans-serif`,
  galanoHeavy: `galanoHeavy, sans-serif`,
  galanoLight: `galanoLight, sans-serif`,
  galanoMedium: `galanoMedium, sans-serif`,
  galanoSemiBold: `galanoSemiBold, sans-serif`,
